...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('vendor/laraval/vendor/highlightjs/styles/zenburn.css') }}">
...
<!-- demo scripts <script src="{{ asset('vendor/laraval/vendor/jquery.validate/dist/additional-methods.js') }}"></script> -->
